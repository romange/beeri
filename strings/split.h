...
bool SplitStringAndParse(StringPiece source, StringPiece delim,
                         bool (*parse)(const StringPiece& str, T* value),
                         vector<T>* result);
template <class Container>
bool SplitStringAndParseToContainer(
    StringPiece source, StringPiece delim,
    bool (*parse)(const StringPiece& str, typename Container::value_type* value),
    Container* result);

template <class List>
bool SplitStringAndParseToList(
    StringPiece source, StringPiece delim,
    bool (*parse)(const StringPiece& str, typename List::value_type* value),
    List* result);
// ----------------------------------------------------------------------
// SplitRange()
