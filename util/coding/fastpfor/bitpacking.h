 ...
 */
#ifndef _UTIL_CODING_PFOR_BITPACKING
#define _UTIL_CODING_PFOR_BITPACKING

/* Packs and unpacks exactly 32 integers using the specified bitwidth (choosen at compile time).
   For example, __fastpack1 reads 32 1-bit integers from in and packs them into a single 32bit
   integer in out.
*/
...
#endif // _UTIL_CODING_PFOR_BITPACKING
